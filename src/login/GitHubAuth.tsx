    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-all duration-300">
        ...
        <div className="p-6">
          ...
          {/* Error Message */}
          {authError && (
            /* Removed the extra condition, error message shows regardless of state if error exists */ <div className="mb-6 bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-4 rounded-md">
              {/* ... error content ... */}
              <div className="flex">
          ...
          {(authState === "idle" || authState === "error") && (
            <div className="flex flex-col items-center space-y-4">
              ...
              {/* Removed the redundant 'disabled' prop */}
              <button
                onClick={login}
                className="w-full mt-2 flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed text-white transition-colors duration-300 font-medium py-3 px-4 rounded-lg"
              >
